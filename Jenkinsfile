...
agent any
    ...
    stage ('setup monitoring') {
        steps {
            ...
            sh 'helm upgrade --install --timeout=900 prometheus prometheus-community/kube-prometheus-stack --namespace monitoring --set grafana.service.type=NodePort --set promotheus.service.type=NodePort'
